...
// gui.add(material, 'iridescenceIOR', '0').min(1).max(1000).step(1)
// gui.add(material, 'iridescenceIOR', '1').min(1).max(1000).step(1)

//Transmisson
material.transmission = 1
material.ior = 1.5
material.thickness = 0.5
//IOR = index of refraction, depends on the materials u want to stimulate
//diamond = 2.417
//water = 1.333
//air = 1.000293
